...
const htmlFiles = ['index', 'about-us', 'blogs', 'blog-details', 'case-studies', 'case-study-details', 'contact-us', 'faqs', 'services', 'service-details', 'team', 'team-details'].map(
  ...
  plugins: [
    ...
    new HtmlWebpackSimpleIncludePlugin([
      ...
      },
      {
        tag: "<include-team />",
        content: fs.readFileSync(
          path.resolve(__dirname, "src/partials/team.html")
        ),
      },
      {
        tag: "<include-our-clients />",
        content: fs.readFileSync(
          path.resolve(__dirname, "src/partials/our-clients.html")
        ),
      },
      {
        tag: "<include-recent-project />",
        content: fs.readFileSync(
          path.resolve(__dirname, "src/partials/recent-project.html")
        ),
      },
      {
        tag: "<include-head />",
