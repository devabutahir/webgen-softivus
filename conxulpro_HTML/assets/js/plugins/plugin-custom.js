...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $(function ($) {
      ...
      let clientsSaysCarousel = document.querySelector('.clients-says-carousel');
      let clientsSaysBtn = document.querySelector('.clients-says-btn');
      if(clientsSaysCarousel){
        const swiper = new Swiper(clientsSaysCarousel, {
          loop: true,
          autoplay: {
            delay: 2000,
          ...
          navigation: {
            nextEl: clientsSaysBtn.querySelector('.ara-next'),
            prevEl: clientsSaysBtn.querySelector('.ara-prev'),
          },
          breakpoints: {
            1200: {
                slidesPerView: 3,
