...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $(function ($) {
      ...
      let integrationsCarousel = document.querySelector('.integrations-carousel');
      if(integrationsCarousel){
        const swiper = new Swiper(integrationsCarousel, {
          loop: true,
          speed: 2000,
          autoplay: {
            delay: 1,
      ...
      // more-article-carousel
      let moreArticleCarousel = document.querySelector('.more-article-carousel');
      if(moreArticleCarousel){
        const swiper = new Swiper(moreArticleCarousel, {
          loop: true,
          speed: 2000,
          autoplay: {
            delay: 1,
