...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $(function ($) {
    ...
    $(window).on("scroll", function () {
      ...
      // sidebar close open
      var activeItem = $(".sidebar-mid-area .active-item");
      var inActiveItem = $(".sidebar-mid-area .inactive-item");
      ...
      var percentageValue = 0 - (scrollPosition / (maxScroll * 2)) * 100;
      $('.element-one').css('left', 'calc(' + percentageValue + '% - 0px)');
      $('.element-two').css('right', 'calc(' + percentageValue + '% - -1px)');
      
      var percentageValue = scrollPosition / maxScroll;
      var scaleValue = 0.0 + percentageValue * (1.0 - 0.0);
      $('.divider-content').css('transform', 'scale(' + scaleValue + ')');
    });
