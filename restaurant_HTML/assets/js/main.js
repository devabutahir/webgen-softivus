...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $(function ($) {
    ...
    $('.navbar-toggle-btn').on('click', function () {
      ...
      // $('.header-section.desktop-menu').toggleClass('sidebar-menu-active');
    ...
    // navbar clone 
    const clone = $('.header-section.sidebar-menu .custom-nav').clone();
    clone.appendTo('.header-section.desktop-menu .desktop-menu-inner');
    ...
    function navClassChanger() {
      var windowWidth = $(window).width();
      if (windowWidth < 1750) {
        $('.nav-wrapper').addClass('gap-0 gap-xl-10 gap-xxl-20');
        $('.nav-wrapper').removeClass('justify-content-between');
      } else {
        $('.nav-wrapper').addClass('justify-content-between');
        $('.nav-wrapper').removeClass('gap-0 gap-xl-10 gap-xxl-20');
      }
    }
    ...
    function bannerClassChanger() {
      var windowWidth = $(window).width();
      if (windowWidth < 1550) {
        $('.banner-section .banner-carousel').addClass('col-lg-10');
        $('.banner-section .banner-carousel').removeClass('col-lg-12');
      } else {
        $('.banner-section .banner-carousel').addClass('col-lg-12');
        $('.banner-section .banner-carousel').removeClass('col-lg-10');
      }
    }
